...
if __name__ == '__main__':
    ...
    if args.bert_model == 'bert-base-multilingual-cased':
        ...
        if 'giga' in args.exp_name:
            my_path = '/data/lan/BiBERT/saved_model/' + args.bert_model + '/giga/'
        else:
            my_path = '/data/lan/BiBERT/saved_model/' + args.bert_model + '/org/'
        model = XLMRobertaForSentClassification.from_pretrained(my_path,
                                        cache_dir=args.output_dir,
                                        num_labels = num_labels,
                                        output_hidden_states=True) # if you want to get all layer hidden states
    else:
        ...
        model.load_state_dict(torch.load('/data/lan/BiBERT/saved_model/' + args.bert_model + '/pytorch_model.bin', map_location=device),
    ...
    if 'source' in args.exp_name:
        ...
        dev_data_path = '../'+target_language + '_arl/dev.json'
    ...
    if args.bert_model == 'bert-base-multilingual-cased':
        ...
        #if args.bert_model == 'bibert' or args.bert_model == 'bibert-64k' or args.bert_model == 'csbert':
