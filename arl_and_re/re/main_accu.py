...
if __name__ == '__main__':
    ...
    if 'source' in args.exp_name:
        dev_data_path = '../' + source_language + '_re/dev.json'
    else:
    ...
    model = train(model, train_dataloader=train_dataloader, dev_size=dev_size, dev_dataloader=dev_dataloader,
                  ...
                  save_ckpt=save_ckpt, save_config=save_config, accumulation_steps=args.gradient_accumulation_steps)
