## POS
This repo contains code and data for POS in [GigaBERT](https://arxiv.org/pdf/2004.14519.pdf):
...
```
python main_pos_ud.py --source_language en --target_language ar --bert_model GigaBERT-v3 --output_dir save --exp_name zeroshot --gpuid 0
'''
