...
if __name__ == '__main__':
    ...
    if args.bert_model == 'bert-base-multilingual-cased':
        ...
        model = XLMRobertaForPOS.from_pretrained('/data/lan/BiBERT/saved_model/'+args.bert_model+'/giga/',
                                           cache_dir=args.output_dir,
                                           num_labels=num_labels,
                                           output_hidden_states=True)  # if you want to get all layer hidden states
    else:
    ...
    if 'source' in args.exp_name:
        dev_data_path = 'UD_' + lang2full[source_language] + '/' + source_language+'-ud-dev.conllu'
    else:
    ...
    if args.bert_model == 'bert-base-multilingual-cased':
        ...
        if 'bibert' in args.bert_model or 'csbert' in args.bert_model:
